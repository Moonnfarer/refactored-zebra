...
def hero_select(): 
    ...
    if choice == "1": 
        ...
        player = Warrior(hero_name, 120, 50, 0) 
        player.stats() 

        return player
    if choice == "2": 
        hero_name = input("Namn: ")
        player = Wizard(hero_name, 100, 15, 50) 
        player.stats() 
